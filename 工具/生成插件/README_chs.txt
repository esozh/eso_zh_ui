...
###官网客户端:
1. 
下载插件包并解压得到esoui、gamedata和EsoZH 3个文件夹，
...
注：每次游戏更新后重新执行第二步修改UserSettings.txt文件操作，
汉化插件版本更新不需要按第二步修改UserSettings.txt文件。
注：从来没有启动过游戏的新玩家是看不到“我的文档/Elder Scrolls Online/”
文件夹的，所以必须先启动一次游戏以后才会自动生成这个文件夹。
